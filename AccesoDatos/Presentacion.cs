        ...
        public DataTable Listar()
        {
            ...
            if (error.Equals(string.Empty))
            {
                using (conexion = new SqlConnection(cadena))
                {
                    ...
                    sqlCmd.CommandText = "PaPresentacionListar";
        ...
        public DataTable Seleccionar()
        {
            ...
            if (error.Equals(string.Empty))
            {
                using (conexion = new SqlConnection(cadena))
                {
                    ...
                    sqlCmd.CommandText = "PaPresentacionSeleccionar";
        ...
        public int Insertar()
        {
            ...
            if (error.Equals(string.Empty))
            {
                using (conexion = new SqlConnection(cadena))
                {
                    ...
                    sqlCmd.Parameters.AddWithValue("@presentacion", PresentacionProducto);
                    sqlCmd.Parameters.AddWithValue("@usuarioRegistro", UsuarioRegistro);

                    sqlCmd.CommandText = "PaPresentacionInsertar";
        ...
        public int Actualizar()
        {
            ...
            if (error.Equals(string.Empty))
            {
                using (conexion = new SqlConnection(cadena))
                {
                    ...
                    sqlCmd.CommandText = "PaPresentacionActualizar";
        ...
        public int Eliminar()
        {
            ...
            if (error.Equals(string.Empty))
            {
                using (conexion = new SqlConnection(cadena))
                {
                    ...
                    sqlCmd.CommandText = "PaPresentacionEliminar";
