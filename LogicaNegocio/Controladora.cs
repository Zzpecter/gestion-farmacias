...
namespace LogicaNegocio
{
    public class Controladora
    {
        ...
        /// <summary>
        /// Inserta puntuacion correcta y verifica si el campo puede ser convertido a decimal.
        /// </summary>
        /// <param name="precio"></param>
        /// <returns> 
        /// cadena formateada de precio.
        /// cadena vacia si no es posible la transformacion.
        /// </returns>
        public string CampoPrecio(string precio)
        {
            string aux = precio.Replace(".", ",");

            Decimal value;
            if (Decimal.TryParse(aux, out value))
                return (aux);
            else
                return(String.Empty);
        }
